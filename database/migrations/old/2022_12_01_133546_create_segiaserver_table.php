...
class CreateSegiaserverTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('classes', function (Blueprint $table) {
            ...
            $table->string('cod')->nullable();
            $table->string('description')->nullable();
            $table->integer('category_id')->index('classe_category_id');
            $table->timestamp('created_at')->useCurrent();
            $table->timestamp('updated_at')->useCurrent();
        });
        ...
        Schema::create('persons', function (Blueprint $table) {
            ...
            $table->string('father_workstation', 50)->nullable();
            $table->string('mother_workstation', 50)->nullable();
            ...
            $table->date('BI_issue_date')->nullable();
            $table->string('nuit', 50)->nullable();
            $table->string('email')->nullable();
            $table->string('contact', 50)->nullable();
            $table->integer('nationality_id')->nullable();
            $table->string('profile_picture')->nullable();
            $table->string('cPostal', 50)->nullable();
            $table->string('city', 50)->nullable();
            $table->string('district', 50)->nullable();
            $table->string('province', 50)->nullable();
            $table->string('numero_casa', 50)->nullable();
        ...
        Schema::create('schools', function (Blueprint $table) {
            ...
            $table->boolean('isCentro')->default(false);
            $table->timestamp('created_at')->useCurrent();
            $table->timestamp('updated_at')->useCurrent();
        });
        ...
        Schema::create('students', function (Blueprint $table) {
            ...
            $table->string('enc_name', 50)->nullable();
            $table->string('enc_contact', 50)->nullable();
            $table->string('enc_email', 50)->nullable();
            $table->string('enc_work', 50)->nullable();
            $table->timestamp('created_at')->useCurrent();
        ...
        Schema::table('classes', function (Blueprint $table) {
            $table->foreign(['category_id'], 'classes_ibfk_1')->references(['id'])->on('categories')->onUpdate('CASCADE')->onDelete('CASCADE');
        });

        Schema::table('class_subjects', function (Blueprint $table) {
            $table->foreign(['subject_id'], 'class_subjects_ibfk_2')->references(['id'])->on('subjects')->onUpdate('CASCADE')->onDelete('CASCADE');
        ...
        Schema::table('students', function (Blueprint $table) {
            $table->foreign(['person_id'], 'students_ibfk_1')->references(['id'])->on('persons')->onUpdate('CASCADE')->onDelete('CASCADE');
        });
